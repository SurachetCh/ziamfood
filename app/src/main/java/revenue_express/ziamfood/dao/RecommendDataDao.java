...
public class RecommendDataDao {
    ...
    public RecommendDataDao(Integer id, String name, String phone, String website, String state_code, String address, String zipcode, String map_position, String img_cover, String img_cover_thumb, String img_logo, String img_logo_thumb, Double distance, Double score_rate, Double price_rate) {
        this.id = id;
        this.name = name;
        this.phone = phone;
