 ...
 */
public class NearByDataDao {
    Integer id;
    String name,phone,website,state_code,address,zipcode,map_position,img_cover,img_cover_thumb,img_logo,img_logo_thumb,distance;
    Double score_rate,price_rate;
    public NearByDataDao(Integer id, String name, String phone, String website, String state_code, String address, String zipcode, String map_position, String img_cover, String img_cover_thumb, String img_logo, String img_logo_thumb, String distance, Double score_rate, Double price_rate) {
        this.id = id;
        this.name = name;
        this.phone = phone;
