...
public class NewShopActivity extends AppCompatActivity {
    ...
    RecyclerView new_shop_recycler_view;
    private SwipeRefreshLayout swipeContainer;

    SwipeRefreshLayout swipeRefreshLayout;
    ImageView imgBack,imgLoad;
    private NewShopTestAdapter mAdapter;
    String serverUrl;
    String access_token;
    String map_position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendNamePageGoogleAnalytics("NewShopActivity");
        ...
        new_shop_recycler_view = (RecyclerView) findViewById(R.id.new_shop_recycler_view);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 1);
        new_shop_recycler_view.setLayoutManager(layoutManager);
        new_shop_recycler_view.setItemAnimator(new DefaultItemAnimator());
        new_shop_recycler_view.setHasFixedSize(true);
        ...
        Glide.with(NewShopActivity.this)
...
//        NewShopActivity.AsyncDataClass asyncRequestObject = new NewShopActivity.AsyncDataClass();
//        asyncRequestObject.execute(serverUrl, access_token,"1","10","desc");
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        try {
                                            ...
                                            mAdapter = new NewShopTestAdapter(NewShopActivity.this,categoery);
                                            new_shop_recycler_view.setAdapter(mAdapter);
                                            if (loadmoreItem.equals("true")){
                                                new_shop_recycler_view.scrollToPosition(lastItem);
                                            }
                                            loadmoreItem = "false";
                                            imgLoad.setVisibility(View.INVISIBLE);
    ...
    public class NewShopTestAdapter extends RecyclerView.Adapter<NewShopTestAdapter.ViewHolder> {

        ArrayList<RecommendDataDao> list;
        Context context;

        public NewShopTestAdapter(Context context, ArrayList<RecommendDataDao> list) {
            this.list = list;
